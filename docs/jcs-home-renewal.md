...
Tested implementation: [`1c2c16b`](https://github.com/XRBitcoinCash/JCS-token-on-the-XRPL/commit/1c2c16b7dd887af46a12c71c98ee645ff22fd351), committed directly to `main`. Publishing these release notes does not change the tested application files.
